...
class ManufacturerSalePostController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('posts.manufacturer', compact('posts', 'manufacturers', 'build_types',  'profile_image', 'users', 'manufacturer_count'));
    }
}