              ...
              <form class="px-4 py-3" action="{{ route('admin.build-type.update', $build_type->id) }}" method="POST" enctype="multipart/form-data" >
                ...
                <span class="position-relative">
                  <label for="image" id="upload_icon">
                    <img src="/images/build_types/{{ $build_type->id}}.png" class="upload_image_icon" id="image_preview" onclick="myFunction()" title="Edit Profile Image">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $build_type->name) }}" placeholder="Your Name">
                  @error('name')
