              ...
              <form class="px-4 py-3" action="{{ route('admin.manufacturer.update', $manufacturer->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <span class="position-relative">
                  <label for="image" id="upload_icon">
                    <img src="/images/manufacturer_logos/{{ $manufacturer->id}}.png" class="upload_image_icon" id="image_preview" onclick="myFunction()" >
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $manufacturer->name) }}" placeholder="Your Name">
                  @error('name')
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <a href="{{ route('admin.manufacturer.index') }}" class="btn btn-outline-secondary fw-bold" style="width: 30%;">Cancel</a>
                </div>
