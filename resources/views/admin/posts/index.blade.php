                ...
                <table id="datatablesSimple" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <div class="d-flex">
                                <form action="{{ route('admin.sell.update', $post->id ) }}" method="POST" >
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn btn-sm btn-outline-secondary fw-bold me-2">Edit</button>
                                </form>
                                <form action="{{ route('admin.sell.destroy', $post->id ) }}" method="POST" onclick="return confirm('Delete post will be permanently! Cannont be Undone! Are you sure?')">
                                    @method('DELETE')
                                    @csrf
