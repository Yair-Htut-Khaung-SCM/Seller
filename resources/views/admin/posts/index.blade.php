...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Sale Posts</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Sale Posts</li>
        </ol>
        <div class="card mb-4">
            <div class="card-body">
                ...
                <table id="datatablesSimple" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <div class="d-flex">
                                <form action="{{ route('admin.sell.post.update', $post->id ) }}" method="POST" >
                                    @csrf
                                    <button type="submit" class="btn btn-sm btn-outline-secondary fw-bold me-2">Edit</button>
                                </form>
                                <form action="{{ route('admin.sell.post.destroy', $post->id ) }}" method="POST" onclick="return confirm('Delete post will be permanently! Cannont be Undone! Are you sure?')">
                                    @method('DELETE')
                                    @csrf
