...
<main class="container col-12 col-md-8 mx-auto">
  <header class="my-4">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('buy.post.index') }}">{{__('posts')}}</a></li>
  ...
  <div>
    ...
    <div class=" content-2 p-4 mt-2 mb-3 bg-light rounded">
      <form action="{{route('buy.post.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mt-2">
          <!-- Image Upload -->
          <div class="card border-rounded mb-2">
            ...
            <div class="card-body container p-3 ">
              ...
              <div class="d-flex flex-wrap">
                ...
                <input type="file" name="files[]" id="files" class="disabled @error('files') is-invalid @enderror @error('files.*') is-invalid @enderror" accept="image/*,.jpg,.gif,.png,.jpeg">
                @error('files')
