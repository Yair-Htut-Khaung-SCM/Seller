...
<main class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <form class="d-flex" action="{{ route('buy.index') }}" method="get">
                    ...
                    @foreach($manufact as $manufacturer)
                    ...
                    @endforeach                                 
                    @endif
                    <input type="hidden" name="car_status" value="buy">
    ...
    <div class="bg-light rounded mt-3 mb-5 p-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <form action="{{ route('buy.index') }}">
                                ...
                                @endif
                                <input type="hidden" name="car_status" value="buy">
                                <input type="hidden" name="price" id="pricehl_id" value='desc'>
                                <button class="dropdown-item" type="submit" onclick="pricehl()">{{ __('Price : High - Low') }}</button>
                            </form>
                        </li>
                        <li>
                            <form action="{{ route('buy.index') }}">
        ...
        <h5 class="text-black mb-3">
            ...
            @php($allitems = request('condition_status'))
            @foreach($allitems as $eachitem)
            <span class="result" style="background-color:rgb(97, 213, 136);">
            {{ $eachitem}}
            </span>
            @endforeach                               
             @endif
             ...
             @php($allitems = request('color_cars'))
             @foreach($allitems as $eachitem)
             <span class="result" style="background-color:rgb(97, 213, 136);">{{ __('Color') }} - {{ $eachitem}}</span>
             @endforeach                                 
             @endif
