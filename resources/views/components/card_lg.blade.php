...
<div class="cols rounded " style="width: 100%;">
    ...
    <div class="card custom_box rounded-4">
                ...
                <div class="card-body p-2">
                    <div class="p-1 pt-0 pb-0">
                        <div class="" style="height:2rem;">
                            ...
                            <span class="price ps-2">{{ number_format($post->price) }}
                    ...
                    <div style="font-size: 0.8rem; font-weight:600;">
                        <span class="description">
                            {{ $post->engine_power ? $post->engine_power.' cc' : null }}
                            {{ $post->gear ? ' • '.$post->gear.'-speed' : null }}
                            {{ $post->transmission ? $post->transmission : null }}
                            {{ $post->mileage ? ' • '.$post->mileage.' km' : null }}
                        </span>
                        <span class="publish_date">{{ date("M d Y", strtotime($post->published_at)) }}</span>
                    </div>
                </div>
                <div class="overlay-lg">
                    <div class="content">
                        <p>
            ...
            <div class="card-footer p-2 d-flex">
                ...
                <div class="col-11">
                    <a href="\profile\{{$saleProfile}}\{{ $post->user_id }}" class="text-decoration-none">
                        ...
                        <span class="ms-2" style="color:#39B87E; font-size: 0.8rem; font-weight:600;">
                            {{ Str::limit($users [$user]->name, 30) }}
                        </span>
                    </a>
                </div>
        ...
        <div class="backLg">
            <div class="card-header"><button class="btn btn-close undoLg"></button></div>
            <div class="card-body">
            ...
            <a href="{{ $route }}" target="_self" title="Lot: #000{{$post->id}} Post Link" style="text-decoration: none; color:black;" class="">
