...
<div id="load">    
  <svg class="loader" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="#12ca8a">
  <g class="car"  fill="#12ca8a">
  ...
  <div id="load" style="background-color: rgb(0, 0, 0, 0);">
  <h5 style="color:#12ca8a; padding-top:140px;">Loading....</h5>
  </div>
</div>
<script>
