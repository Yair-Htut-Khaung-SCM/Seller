        ...
        <div class="row">
            ...
            <div class="col">
                <div class="text-center">
                    ...
                    @if(request()->fullUrl()=='http://localhost:8000/build_type/sale/post?build_type_id='.$i)
                    <a href="{{ route('build_type.buy.post.index','&build_type_id='.$i) }}" class="text-decoration-none h3 mx-3 mt-5 " style="color: #12ca8a">{{ __('buy_post') }}</a>
                    <a href="{{ route('build_type.sale.post.index','&build_type_id='.$i) }}" class="text-decoration-none h3 mx-3 mt-5" style="color: #12ca8a; border-bottom: 2px solid #12ca8a;">{{ __('sale_post') }}</a>
                    @endif
                    @endfor
                </div>
            </div>
