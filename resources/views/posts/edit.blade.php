...
<main class="container">
  ...
  <div class="container">
    <div class="bg-light rounded mt-2">
      <h2 class="p-3" style="color:#12ca8a;">Edit SALE Form</h2>
    </div>
    ...
    <div class=" p-4 pb-2 mt-2 mb-3 bg-light rounded">
      <form action="{{ route('sale.post.update',$post->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-2">
          ...
          <div class="card mt-2">
            <div class="card-header head_title">
              <h5 class="text-white">{{__('sale_info')}}</h5>
            </div>
            <div class="card-body">
              ...
              <div class="col-sm-12 p-2">
                ...
                <div class="input-group">
                  <input type="number" class="form-control  @error('price') border-danger @enderror" name="price" value="{{ old('price', $post->price) }}">
