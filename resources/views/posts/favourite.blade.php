...
<main class="container">
    ...
    <div class="container">
        <div class="bg-light rounded my-2 text-center p-3">
            ...
            <a href="{{ route('buy.post.favourite') }}" class="text-decoration-none h3 mx-3 mt-5" style="color: #12ca8a;">Buy Posts</a>
            <a href="{{ route('sale.post.favourite') }}" class="text-decoration-none h3 mx-3 mt-5" style="color: #12ca8a; border-bottom: 2px solid #12ca8a;">Sale Posts</a>
        </div>
