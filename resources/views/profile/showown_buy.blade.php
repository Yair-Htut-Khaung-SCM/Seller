        ...
        <div class="bg-light p-0 border rounded mb-3">
            <h5 class=" p-3 card_head_title border rounded" style="margin: 0px;">User's Uploaded Posts</h5>
                ...
                <div class="bg-light rounded my-2 text-center p-3">
                    <a href="\profile\sale" class="text-decoration-none h3 mx-3 mt-5" style="color: #12ca8a;">{{ __('sale_post') }}</a>
                    <a href="\profile\buy" class="text-decoration-none h3 mx-3 mt-5" style="color: #12ca8a; border-bottom: 2px solid #12ca8a;">{{ __('buy_post') }}</a>
                </div>
