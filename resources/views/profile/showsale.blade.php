        ...
        <div class="bg-light p-0 border rounded mb-3">
            ...
            <div class="tabs">
              <div class="bg-light rounded my-2 text-center p-3">
                <a href="\profile\sale\{{ $user->id }}" class="text-decoration-none h3 mx-3 mt-5" style="color: #12ca8a; border-bottom: 2px solid #12ca8a;">{{ __('sale_post') }}</a>
                <a href="\profile\buy\{{ $user->id }}" class="text-decoration-none h3 mx-3 mt-5" style="color: #12ca8a;">{{ __('buy_post') }}</a>
            </div><!-- END tabs-nav -->
                <div id="tabs-content" class="col-12" style="background-color: none; height: max-content !important; margin-top:20px; margin:0 auto ;">
                    <div id="tab1" class="tab-content row row-cols-1 row-cols-sm-2 row-cols-md-3 p-4 g-4" style="display:flex; background-color:transparent !important; height:max-content !important; margin-right:0px !important;">
                        @if($posts->count())
